import { hasConflict, toggle, getCourseNumber, getCourseTerm,timeParts } from '../utilities/times.js';
import { setData,useUserState,useAuthState } from '../utilities/firebase.js';
